...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	...
	define ('PDF_HEADER_TITLE', 'VBR Vanguardia Bicentenaria Republicana
');

	/**
	 * header description string
	 */
	define ('PDF_HEADER_STRING', "VBR Vanguardia Bicentenaria Republicana");

	/**
	 * image logo
	 */
	define ('PDF_HEADER_LOGO', '../images/imagen-registro_liston.png');
